        ...
        <div class="featured-card__content">
          ...
          <p class="featured-card__more-info">
            <a :href="wikipediaSearch" target="_blank">
              <svg class="featured-card__more-info-icon" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 27 18">
                <path
...
// @TODO Make it dynamic through global state.
const highlightedCeleb = ref<ICelebrity>(celebrities[0]);

const wikipediaSearch = computed(() => `https://en.wikipedia.org/wiki/${highlightedCeleb.value.name}`);
</script>
@/interfaces/celebrities